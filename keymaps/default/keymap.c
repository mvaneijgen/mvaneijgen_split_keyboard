...
/* ,----------------------------------------.                ,-----------------------------------------.
  ...
  [_BASE] = LAYOUT(
    ...
    MO(_NUMSYM), MO(_NUMSYM), LT(_RESET, KC_ENT), KC_DEL, KC_BSPC, KC_SPC, MO(_CTRL), KC_MUTM
  ),
  [_GAME] = LAYOUT(
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [_BASE] =   { ENCODER_CCW_CW(KC_VOLU, KC_VOLD), ENCODER_CCW_CW(KC_VOLU, KC_VOLD) },
    [_NUMSYM] = { ENCODER_CCW_CW(KC_MS_WH_UP, KC_MS_WH_DOWN), ENCODER_CCW_CW(KC_MS_WH_UP, KC_MS_WH_DOWN) },
    [_CTRL] =   { ENCODER_CCW_CW(KC_BRMU, KC_BRMD), ENCODER_CCW_CW(KC_BRMU, KC_BRMD) },
